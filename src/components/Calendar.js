...
const Calendar = () => {
  ...
  const exportToCSV = () => {
    ...
    const rows = events.map((e) => [e.title, e.date, e.start, e.end, e.category]);
              ...
              {dayEvents.map((event, idx) => {
                ...
                return (
                  <div
                    ...
                    className="event"
                    draggable
                    onDragStart={() => setDraggedIndex(eventIndex)}
                    style={{
                  ...
                  >
                    ...
                    <br />
                    <button
                      style={{ fontSize: '10px', marginTop: '4px', marginRight: '6px' }}
